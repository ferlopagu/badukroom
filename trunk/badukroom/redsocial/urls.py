...
from redsocial.views import perfil, home, crea_comentario, buscador, agregar_ajax, contar_notificaciones, ver_notificaciones, aceptar_peticion, declinar_peticion, limpiar_notificaciones, eliminar_ajax, grupo, lista_grupos, responder, amigos, partidas, partidas_ajax, partidas_jugador, revisiones, crear_grupo, partidas_by_revisor, enviar_partida_revisar, aceptar_partida_revisar, ver_partida, eliminar_comentario_ajax, perfil_ajax, home_ajax, crear_partida_repositorio, unirse_revisor, dejar_revisor, fuerza_revisor, fuerza_jugador, recargar_repositorio_ajax, partidas_entre_fechas, rest_perfil
